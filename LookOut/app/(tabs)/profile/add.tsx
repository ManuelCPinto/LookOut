...
import { useJoinFamily } from "@/hooks/family";
      ...
      >
        <View className="items-center p-6 bg-white rounded-2xl">
          ...
          <Text className="mt-4 text-lg font-semibold text-center text-gray-800">
            Point your camera at the QR code to join the family.
          </Text>
          <TouchableOpacity
        ...
        <View className="items-center p-6 bg-white rounded-2xl">
          ...
          {feedbackStatus === "success" && (
            <>
              ...
              <Text className="mt-4 text-gray-700">Joined Family!</Text>
            </>
          )}
          {feedbackStatus === "error" && (
            <>
              ...
              <Text className="mt-4 text-center text-gray-700">
                {joinError ?? "Failed to add device"}
              </Text>
            </>
          )}
        </View>
